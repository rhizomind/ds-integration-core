...
/**
 * The conditions within the build runtime environment which will trigger the automatic inclusion
 *                 of the parent build profile.
 *             
 * 
 ...
 *         &lt;element name="os" type="{http://maven.apache.org/SETTINGS/1.2.0}ActivationOS" minOccurs="0"/&gt;
 *         &lt;element name="property" type="{http://maven.apache.org/SETTINGS/1.2.0}ActivationProperty" minOccurs="0"/&gt;
 *         &lt;element name="file" type="{http://maven.apache.org/SETTINGS/1.2.0}ActivationFile" minOccurs="0"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
